describe('Add New Employee', function () {
  ...
  it('Soal ke - 2 : Positive Case - Login and Add Jatah Cuti', function() {
    ...
    cy.xpath("//label[text()='Leave Type']/ancestor::div[contains(@class,'oxd-input-group')]//div[contains(@class,'oxd-select-text')]").should('have.text', 'CAN - BereavementCAN - Bereavement');
  ...
  // Test Case Soal 2 -- Negative Case
